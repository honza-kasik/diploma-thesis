...
%TODO What is mod_cluster (with load balancing explanation)
...
\subsubsubsection{DNS load balancer}
...
\subsubsubsection{Content delivery network}
...
\subsubsubsection{Operating-system-level virtualization}
...
%TODO - more complex use cases, more introduction, concrete technology solutions mentioning?

%TODO - Docker vs containers (terminology), podman

\subsubsubsection{Cloud}

Cloud computing based on lending out the server resources is another popular term nowadays.

\subsubsubsection{Microservices}
...
%TODO why there is even another problem?
...
%TODO mention a bug where the uptime on CPU caused the issue.

%TODO introduction to 2nd day testing, relation to soak testing
...
%TODO introduction to Failover testing
...
%TODO Testing is always made in perfect environment - how will the application behave if environment is not perfect (degraded network)?

\subsection{OpenShift, Kubernetes and containers}

%TODO openshift/kubernetes introduction. What part containers play?
...
%TODO explain user docused testing more. Why are these scenarios important?

\section{My contribution/the solution}

\subsection{Openshift/Kubernetes automation}

%TODO introduction to: sunstone, jclouds, xft-cz
...
After bit of research it was clear I needed a hypervisor. First thing which came to my mind was Xen hypervisor. Then, again, I did little bit of research and I settlet with oVirt. Here's why: %TODO.

First, it is important to udnerstand the concept. There are several terms in oVirt namespace which are important:
...
In my case I needed a hardware and a software. You can use two classes of base OS:

\begin{itemize}
  \item oVirt node -- minimal distribution of CentOS based on el7
  \item CentOS/RHEL OS -- You can install oVirt through RPMs


\subsubsection{OpenShift (OKD) installation}

There are ways how to have single-host OpenShift environment (e.g. Minishift), but I needed more real-like one, so the installation was inevitable.

\subsection{Traffic control}

%TODO introduce traffic control daemon
%TODO creating degraded network in Openshift

\subsection{Automate it/putting it together}

%TODO slightl describe the concept

\section{Implementation part}

%TODO walk through the implementation (what I bring)

\section{Conclusion}

%TODO did I met the goals? Why, why not?
